...
snapshot = pickle.load(open("Zaxxon_save_wall.pickle", "rb"))
...
for i in range(1000000):
    ...
    if i > 20 and i % 5 == 0:
        ...
        # env._env.unwrapped.ale.setRAM(26, 74)
        print(env.objects)
        ...
        for i in range(14):
            if ram[78 + i] > 40:
                env._env.unwrapped.ale.setRAM(54 + i, 83)
