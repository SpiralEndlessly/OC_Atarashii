...
DROP_LOW = True
MIN_CORRELATION = 0.5  # 0.8

NB_SAMPLES = 800  # 600 before
game_name = "Berzerk-v4"  # RoadRunner-v4
MODE = "vision"
# RENDER_MODE = "human"
...
# opts.path = "models/Berzerk/dqn.gz"
...
#                 objects_infos[f"{obj}"].append(0)

#                 print(0)
#                 # SKIP = True
#             else:
#                 objects_infos[f"{obj}"].append(1)
...
df = pickle.load(open("berzerk.pkl", "rb"))
