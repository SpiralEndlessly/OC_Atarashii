...
parser.add_argument(
    "-i", "--interval", type=str, default=10, help="The frame interval (default 10)"
)
parser.add_argument(
    "-m", "--mode", choices=["vision", "ram"], default="ram", help="The frame interval"
)
...
print(f"to ocatarashii/{folder}/{opts.game.lower()}.py")
